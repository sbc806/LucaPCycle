...
# word-level
codes_file="step_2_all_sequences_corpus_codes_30000.txt"
seq_subword="step_2_all_sequences_corpus_subword_vocab_30000.txt"
...
cd ../..
torchrun --nproc-per-node=4 --nnodes=1 run_seq_only.py \
  --train_data_dir ../kinases_dataset_1/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/train/ \
  --dev_data_dir ../kinases_dataset_1/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/dev/ \
  --test_data_dir ../kinases_dataset_1/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/test/ \
  ...
  --label_filepath ../kinases_dataset_1/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/label.txt  \
