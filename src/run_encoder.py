...
def main():
    ...
    # encoding
    train_dataset_path = "../kinases_dataset/protein/binary_class/train/train.csv"
    dev_dataset_path = "../kinases_dataset/protein/binary_class/dev/dev.csv"
